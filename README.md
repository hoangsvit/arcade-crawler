...
- `data/arcade_milestones_history/latest.json` cùng archive theo tháng tại mốc đầu ngày UTC hoặc khi có biến động suất; bỏ qua các lần crawl không đổi trong cùng ngày.
